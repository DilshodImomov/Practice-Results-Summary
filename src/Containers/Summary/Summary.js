            ...
            <div className="categories">
                <div className="box red">
                    <div className="part1">
                        ...
                        <p className="boxHeading" >Reaction</p>
                    </div>
                    <p className="score"><strong>80</strong> / 100</p>
                </div>
                <div className="box yellow">
                    <div className="part1">
                        ...
                        <p className="boxHeading" >Memory</p>
                    </div>
                    <p className="score"><strong>92</strong> / 100</p>
                </div>
                <div className="box green">
                    <div className="part1">
                        ...
                        <p className="boxHeading" >Verbal</p>
                    </div>
                    <p className="score"><strong>61</strong> / 100</p>
                </div>
                <div className="box blue">
                    <div className="part1">
                        ...
                        <p className="boxHeading" >Visual</p>
                    </div>
                    <p className="score"><strong>72</strong> / 100</p>
                </div>
            </div>
